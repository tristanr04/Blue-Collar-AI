...
export const DESIGN_SYSTEM = {
  title: 'Blue Collar Financial AI',
  description:
    'Navy + emerald design system for a trust-first financial app built for trade workers. Emerald green for action and clarity; deep navy for structure and security.',
} as const;
