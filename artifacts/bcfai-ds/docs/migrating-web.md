# Migrating web UI to Blue Collar Financial AI Design System

Read `artifacts/bcfai-ds/docs/AGENTS.md` and
`artifacts/bcfai-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/bcfai-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/bcfai-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/bcfai-ds/hooks/use-toast`
