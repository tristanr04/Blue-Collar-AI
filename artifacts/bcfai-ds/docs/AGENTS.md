# Blue Collar Financial AI Design System design system
...
workspace package (`@workspace/bcfai-ds`): other artifacts depend
...
`@workspace/bcfai-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/bcfai-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/bcfai-ds` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/bcfai-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/bcfai-ds/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/bcfai-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/bcfai-ds/docs/migrating-expo.md`
