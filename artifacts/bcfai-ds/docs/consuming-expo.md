# Consuming Blue Collar Financial AI Design System in Expo apps

Read `artifacts/bcfai-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/bcfai-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/bcfai-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/bcfai-ds/lib/native-theme";
import { useColors } from "@workspace/bcfai-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/bcfai-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/bcfai-ds/components/native/badge";
import { Button } from "@workspace/bcfai-ds/components/native/button";
import { Card } from "@workspace/bcfai-ds/components/native/card";
```
...
Import and render
`@workspace/bcfai-ds/components/native/button`, then run Expo
